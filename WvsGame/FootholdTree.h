...
#define HIDWORD(_qw)    ((int)(((_qw) >> 32) & 0xffffffff))
		...
		for (int idx = 0; idx < NODE::MAX_ENTRY; ++idx)
		{
			...
			aCalc[idx].second = std::pow(nWAvg / 2 - nWidthAvg, 2)
...
#undef HIDWORD
	...
	template<class T, class U> int __OFSUB__(T x, U y)
	{
